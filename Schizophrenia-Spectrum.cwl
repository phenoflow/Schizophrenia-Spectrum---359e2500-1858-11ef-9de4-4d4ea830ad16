...
steps:
  ...
  schizophrenia-spectrum-undifferentiated---primary:
    run: schizophrenia-spectrum-undifferentiated---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  brief-schizophrenia-spectrum---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: schizophrenia-spectrum-undifferentiated---primary/output
  ...
  residual-schizophrenia-spectrum---primary:
    run: residual-schizophrenia-spectrum---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  psychogenic-schizophrenia-spectrum---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: residual-schizophrenia-spectrum---primary/output
  output-cases:
